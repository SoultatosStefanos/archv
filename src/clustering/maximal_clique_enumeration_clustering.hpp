...
namespace detail
{
    ...
    {
        explicit clique_map_insert_iterator(CliqueMap& map)
        : cliques { map } { }
    ...
    {
        return clique_contains_vertex(c, boost::source(e, g))
            and clique_contains_vertex(c, boost::target(e, g));
    }

} // namespace detail

template < typename MutableGraph, typename VisitCliques >
void maximum_clique_enumeration_clustering(
    MutableGraph& g, VisitCliques visit_cliques)
{
