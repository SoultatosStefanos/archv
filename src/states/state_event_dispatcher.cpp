...
{
    if (m_sm.has_active_state())
        m_sm.get_active_state()->keyPressed(e);
...
{
    if (m_sm.has_active_state())
        m_sm.get_active_state()->keyReleased(e);
...
{
    if (m_sm.has_active_state())
        m_sm.get_active_state()->touchMoved(e);
...
{
    if (m_sm.has_active_state())
        m_sm.get_active_state()->touchPressed(e);
...
{
    if (m_sm.has_active_state())
        m_sm.get_active_state()->touchReleased(e);
...
{
    if (m_sm.has_active_state())
        m_sm.get_active_state()->mouseMoved(e);
...
{
    if (m_sm.has_active_state())
        m_sm.get_active_state()->mousePressed(e);
...
{
    if (m_sm.has_active_state())
        m_sm.get_active_state()->mouseReleased(e);
...
{
    if (m_sm.has_active_state())
        m_sm.get_active_state()->textInput(e);
...
{
    if (m_sm.has_active_state())
        m_sm.get_active_state()->buttonPressed(e);
...
{
    if (m_sm.has_active_state())
        m_sm.get_active_state()->buttonReleased(e);
...
{
    if (m_sm.has_active_state())
        m_sm.get_active_state()->axisMoved(e);
