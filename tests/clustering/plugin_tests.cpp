...
TEST(clustering_plugin_tests, layered_label_propagation_clusterer_is_plugged_in)
{
    ASSERT_TRUE(
        clustering::is_clusterer_plugged_in(clustering::llp_clusterer_id));
}

TEST(clustering_plugin_tests, infomap_clusterer_is_plugged_in)
{
    ASSERT_TRUE(
        clustering::is_clusterer_plugged_in(clustering::infomap_clusterer_id));
}
